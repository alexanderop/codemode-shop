...
├── architecture.md       <- index for architecture/
├── architecture/         <- project-specific knowledge and gotchas
├── conventions.md        <- index for conventions/
...
- One topic per file. `brain/architecture/deploy-gotchas.md`, not a mega-file.
