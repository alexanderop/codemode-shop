...
- Start the heading with a verb and express the step/part headings as a complete thought. Don't use the _-ing_ form of the verb because it is harder to translate. For example, you could use the heading **Connect to the VM instance** instead of **Connect**.
